        ...
        <?php }else{ 
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" style="min-width:300px;border-radius: 2px;" aria-label="navbarDropdownMenuLink">
                    ...
                    <a class="dropdown-item text-muted" href="configuracoes"><i class="fa fa-user" style="margin-right:10px;"></i> Configurações <span style="padding:0px;margin-bottom:5px;font-size:13px;color:#8b8b8b"></span></a>
