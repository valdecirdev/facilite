<?php
    ...
    class UsuarioModel {
        ...
        {
            if (!is_null($id)) {
                $cidade = $this->loadCity($id);
                $estado = $this->loadState($cidade[0]['id_estado']);
        ...
        public function loadById(int $id):ObjUsuario
        {
            ...
            $this->setInfosUsuario($usuario, $result);
            return $usuario;
        }
        ...
        public function delete(int $id)
        {
            ...
            $sql->query("DELETE FROM tb_confirmacao_email WHERE id_usuario = :ID", array(
                ":ID"=>$id
            ));
        ...
        public function setInfosUsuario(ObjUsuario $usuario, array $infos = array())
        {
            ...
            $usuario->setCidadeUsuario($this->loadFullCity($infos[0]['id_cidade']));
