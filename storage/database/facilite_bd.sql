...
CREATE TABLE `tb_categorias` (
  `id_categoria` int(11) NOT NULL,
  `des_descricao` varchar(64) NOT NULL,
  `des_icone` varchar(64) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_categorias` (`id_categoria`, `des_descricao`, `des_icone`) VALUES
(1, 'Desenvolvimento WEB', 'far fa-file-code'),
(2, 'Desenvolvimento ABAP', 'far fa-file-code'),
(3, 'Serviços Gerais', 'fas fa-wrench');
...
INSERT INTO `tb_cidades` (`id_cidade`, `des_nome`, `id_estado`) VALUES
(1, 'Afonso Cláudio', 8),
...
--
-- Estrutura da tabela `tb_confirmacao_email`
--

CREATE TABLE `tb_confirmacao_email` (
  `id_confirmacao` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `des_hash` varchar(100) COLLATE utf8_swedish_ci NOT NULL
...
INSERT INTO `tb_estados` (`id_estado`, `des_nome`, `des_uf`, `id_pais`) VALUES
(1, 'Acre', 'AC', 1),
(2, 'Alagoas', 'AL', 1),
(3, 'Amazonas', 'AM', 1),
(4, 'Amapá', 'AP', 1),
...
--
-- Estrutura da tabela `tb_formacoes`
--

CREATE TABLE `tb_formacoes` (
  `id_formacao` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `des_titulo` varchar(100) DEFAULT NULL,
  `des_descricao` varchar(1024) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_formacoes`
--
...
CREATE TABLE `tb_habilidades` (
  ...
  `des_descricao` varchar(64) NOT NULL,
  `des_status` varchar(20) NOT NULL DEFAULT 'Ativo'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_habilidades` (`id_habilidade`, `des_descricao`, `des_status`) VALUES
(1, 'PHP', 'Ativo'),
(2, 'ABAP', 'Ativo'),
(3, 'Desenvolvimento Web', 'Ativo'),
(4, 'MySql', 'Ativo'),
(5, 'Banco de dados', 'Ativo');

-- --------------------------------------------------------

--
-- Estrutura da tabela `tb_habilidades_usuarios`
--

CREATE TABLE `tb_habilidades_usuarios` (
...
--
-- Extraindo dados da tabela `tb_habilidades_usuarios`
--
...
--
-- Estrutura da tabela `tb_ligacoes`
--

CREATE TABLE `tb_ligacoes` (
  `id_ligacao` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `id_contato` int(11) NOT NULL,
  `dt_ligacao` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Extraindo dados da tabela `tb_ligacoes`
--
...
INSERT INTO `tb_modalidades` (`id_modalidade`, `des_descricao`) VALUES
(1, 'Hora'),
(2, 'Serviço');
...
INSERT INTO `tb_paises` (`id_pais`, `des_nome`, `des_sigla`) VALUES
(1, 'Brasil', 'BR');
...
--
-- Indexes for table `tb_confirmacao_email`
--
...
ALTER TABLE `tb_experiencias`
  ...
  ADD KEY `tb_experiencias_ibfk_1` (`id_usuario`);

--
-- Indexes for table `tb_formacoes`
--
ALTER TABLE `tb_formacoes`
  ADD PRIMARY KEY (`id_formacao`),
  ADD KEY `tb_formacoes_ibfk_1` (`id_usuario`);
...
--
-- Indexes for table `tb_habilidades_usuarios`
--
...
--
ALTER TABLE `tb_cidades`
  ADD CONSTRAINT `tb_cidades_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `tb_estados` (`id_estado`);
...
--
ALTER TABLE `tb_estados`
  ADD CONSTRAINT `tb_estados_ibfk_1` FOREIGN KEY (`id_pais`) REFERENCES `tb_paises` (`id_pais`);
...
--
ALTER TABLE `tb_usuarios`
  ADD CONSTRAINT `tb_usuarios_ibfk_1` FOREIGN KEY (`id_cidade`) REFERENCES `tb_cidades` (`id_cidade`);
COMMIT;
