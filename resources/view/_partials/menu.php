        ...
        <?php } else { ?>
            ...
            <li class="nav-item dropdown">
                <a aria-label="Meu perfil" class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 16px;">
                    <img class="float-left img-nav-profile rounded-circle" src="/img/profile/<?=$loggedUser->des_foto;?>" height="25" width="25" style="margin-top:-2px">
                    <span class="float-left clearfix d-sm-inline-block text-white" id="navbar-username" style="margin-top:-2px;margin-left:8px;margin-right:8px"><?=$loggedUser->des_nome_exibicao;?></span>
                </a>
                <div class="dropdown-menu dropdown-menu-right" style="min-width:200px;border-radius: 8px;" aria-label="navbarDropdownMenuLink">
                    <div id="dropdown-logged-user" class="row" style="padding: 10px 10px 0 0;width:100%;margin-bottom:-12px;margin-left:0">
                        <div class="col-12 text-center">
                            <a class="img-profile" href="/<?=$loggedUser->des_slug;?>"><img class="img-nav-dropdown rounded-circle" src="/img/profile/<?=$loggedUser->des_foto;?>" height="120" width="120"></a>
                            <a href="/<?=$loggedUser->des_slug; ?>"><p style="color:#8b8b8b">Perfil <span class="text-warning">40%</span> completo</p></a>
                        </div>
                    </div>
